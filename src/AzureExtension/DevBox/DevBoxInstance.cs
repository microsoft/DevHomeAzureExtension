...
public class DevBoxInstance : IComputeSystem
{
    ...
    private IAsyncOperation<ComputeSystemOperationResult> PerformRESTOperation(DevBoxOperation action, HttpMethod method)
    {
        return Task.Run(async () =>
        {
            try
            {
                ...
                var operation = DevBoxOperationHelper.GetDevBoxOperationName(action);
                ...
                _devBoxManagementService.StartDevCenterOperationMonitor(AssociatedDeveloperId, result.ResponseHeader, Constants.OneMinutePeriod, OperationCallback);
    ...
    public void OperationCallback(DevBoxLongRunningOperation longRunningOperation)
    {
        switch (longRunningOperation.Status)
        {
            ...
            default:
                RemoveOperationInProgressFlag();
                UpdateStateForUI();
                Log.Logger()?.ReportError($"Dev Box operation stopped unexpectedly. {longRunningOperation}");
                break;
        }
    }
    ...
    public IAsyncOperation<ComputeSystemOperationResult> StartAsync(string options)
    {
        ...
        return PerformRESTOperation(DevBoxOperation.Start, HttpMethod.Post);
    }
    ...
    public IAsyncOperation<ComputeSystemOperationResult> ShutDownAsync(string options)
    {
        ...
        return PerformRESTOperation(DevBoxOperation.Stop, HttpMethod.Post);
    }
    ...
    public IAsyncOperation<ComputeSystemOperationResult> RestartAsync(string options)
    {
        ...
        return PerformRESTOperation(DevBoxOperation.Restart, HttpMethod.Post);
    }
    ...
    public IAsyncOperation<ComputeSystemOperationResult> DeleteAsync(string options)
    {
        ...
        return PerformRESTOperation(DevBoxOperation.Delete, HttpMethod.Delete);
    }
